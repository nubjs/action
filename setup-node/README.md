...
- `nubjs/action/setup-node@v0`: floating, moves with every `v0.x` release. Breaking changes can land in a `v0.x` release.
- `nubjs/action/setup-node@v0.1.0`: a release, never moves.
